...
#docker run -d -p 9004:9004 public.ecr.aws/l1r4r3i8/distributed-order-service:latest
...
#docker run -d -p 9002:9002 public.ecr.aws/l1r4r3i8/distributed-coupon-service:latest
...
#docker run -p 9003:9003 public.ecr.aws/l1r4r3i8/distributed-product-service:latest
...
#docker run -d -p 9001:9001 public.ecr.aws/l1r4r3i8/distributed-user-service:latest
